...
public class BluetoothServiceOld extends Service implements IBluetoothService {	
    ...
    public class BluetoothBinder extends Binder {
        public IBluetoothService getService() {
            return BluetoothServiceOld.this;
        }
    }
 ...
 // Debugging
    ...
    private synchronized void setState(int state) { 
        ...
        synchronized(messages) {
        	sendToLogger("BluetoothService:"
        			...
        			+ "\n\tupdatingNeighbors: " + updatingNeighbors
        			+ "\n\thostingElection: " + electionHandler.hostingElection
    ...
    public synchronized void connect(BluetoothDevice device) {
        ...
        sendToLogger("BluetoothService:"
        		+ "\n\tCONNECTING TIMEOUT SET (connect)"
        		+ "\n");
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        if (broadcasting) {
	        ...
	        sendToLogger("BluetoothService:"
	        		+ "\n\tRESPONSE TIMEOUT SET (connected)"
	        		+ "\n");
        	sendMessage(null);
        }
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothServiceOld.this) {
                        switch (mState) {
                        case STATE_LISTEN:
    ...
    public synchronized void handleMessage(IBluetoothMessage message) {
